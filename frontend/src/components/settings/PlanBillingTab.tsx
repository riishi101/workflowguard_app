  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-8 flex items-center justify-between">
        ...
        <Button className="bg-green-600 hover:bg-green-700 text-white h-14 px-10 text-lg font-medium ml-8">
          Upgrade Now
        </Button>
      </div>
      ...
      <Card className="shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between pb-8">
          <CardTitle className="tracking-tight text-2xl font-semibold text-gray-900">
        ...
        <CardContent className="p-8 pt-0 space-y-10">
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-4 mb-3">
                ...
                <Badge
                  variant="secondary"
                  className="bg-blue-100 text-blue-800 text-base font-medium px-4 py-2"
                >
                  Trial
                </Badge>
              </div>
          ...
          <div className="grid grid-cols-3 gap-12">
            <div>
              ...
              <Progress value={9.4} className="h-4" />
            </div>
            <div>
              <div className="flex items-center justify-between mb-4">
        ...
        <div className="grid grid-cols-3 gap-10">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-col space-y-1.5 p-8 pb-8">
              ...
              <div className="text-4xl font-bold text-gray-900">
                $29<span className="text-xl font-normal text-gray-600">/month</span>
              </div>
            </CardHeader>
          ...
          <Card className="border-blue-500 border-2 hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-col space-y-1.5 p-8 pb-8">
              ...
              <div className="text-4xl font-bold text-gray-900">
                $59<span className="text-xl font-normal text-gray-600">/month</span>
              </div>
            </CardHeader>
            <CardContent className="p-8 pt-0 space-y-6">
              <div className="space-y-4">
              ...
              <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white h-14 text-lg font-medium">
                Current Plan
              </Button>
            </CardContent>
          </Card>
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="p-8 pt-0">
          ...
          <Button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white h-14 px-10 text-lg font-medium"
          >
