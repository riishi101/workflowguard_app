...
let CreateUserDto = (() => {
    ...
    return _a = class CreateUserDto {
            constructor() {
                ...
                this.jobTitle = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _jobTitle_initializers, void 0));
        ...
        (() => {
            ...
            _jobTitle_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
