...
const mockVersionHistory = [
  {
    id: "v5",
    version: "Version 5",
    dateTime: "August 4, 2025 at 17:01 IST",
    lastModifiedBy: "Sarah Chen",
    changeSummary:
      "Added 'Send Internal Email' action and updated trigger condition for lead score > 75",
  ...
  },
  {
    id: "v4",
    version: "Version 4",
    dateTime: "August 4, 2025 at 14:23 IST",
    lastModifiedBy: "Mike Johnson",
    changeSummary:
      "Modified email template in step 3, updated delay timing from 2 days to 1 day",
  ...
  },
  {
    id: "v3",
    version: "Version 3",
    dateTime: "August 3, 2025 at 11:45 IST",
    lastModifiedBy: "Sarah Chen",
    changeSummary:
      "Removed 'SMS notification' action, added new branch for premium customers",
    changeType: "Manual Save",
    isCurrent: false,
  },
  {
    id: "v2",
    version: "Version 2",
    dateTime: "August 2, 2025 at 16:30 IST",
    lastModifiedBy: "Alex Rivera",
    changeSummary:
      "Updated contact property filters, changed enrollment trigger from 'Contact created' to 'Lead score updated'",
    changeType: "System Backup",
    isCurrent: false,
  },
  {
    id: "v1",
    version: "Version 1",
    dateTime: "August 1, 2025 at 09:15 IST",
    lastModifiedBy: "Sarah Chen",
    changeSummary:
      "Initial workflow creation with basic email sequence and lead scoring triggers",
    changeType: "Manual Save",
    isCurrent: false,
  },
];
...
export default function Index() {
  ...
  const [selectedVersionForRollback, setSelectedVersionForRollback] = useState<
    string | null
  >(null);
  const [viewVersionOpen, setViewVersionOpen] = useState(false);
  const [selectedVersionForView, setSelectedVersionForView] = useState<
    string | null
  >(null);
  ...
  const confirmRollback = () => {
    ...
    console.log("Rolling back to version:", selectedVersionForRollback);
